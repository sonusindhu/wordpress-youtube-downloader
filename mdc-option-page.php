            ...
            <table class="form-table">
                <tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td><input type="checkbox" value="1" id="mdc_show_thumbnail" name="mdc_show_thumbnail" <?php if (get_option('mdc_show_thumbnail') == 1) {
        echo "checked";
    } ?> /></td>
                    </tr>
                    <tr valign="top">
                        <th scope="row"><label for="mdc_show_quality">Show Video Qualities</label></th>
                        <td><input type="checkbox" value="1" id="mdc_show_quality" name="mdc_show_quality" <?php if (get_option('mdc_show_quality') == 1) {
        echo "checked";
    } ?> /></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <textarea type="text" id="mdc_custom_css" name="mdc_custom_css" style="height: 200px; width: 340px;"><?php if (get_option('mdc_custom_css')) {
